	...
	<body>
      ...
      <h1>TRAVELLERS</h1>
        ...
        ob_end_clean();
            ...
            $flightno = $_GET['role'];
            $sql = "select a.flightname , r.from_x , r.to_x , r.timedept, r.timearr , a.basefare from airline a join routes r on a.routeno = r.routeid where a.flightno = '$flightno'";
    ...
    <?php
                ...
                if(isset($_POST['userbut'])){
                    ...
                    while($k < sizeof($usernames)){
                        $sql1 = "insert into user(username , flightno , email , phoneno , trav_date) values('$usernames[$k]' , '$flightno' , '$emails[$k]' , '$phone[$k]' , '$traveldate')";
                        $query = mysqli_query($conn , $sql1);
                        $last_id = mysqli_insert_id($conn);
                        $sql2 = "insert into seats values('$flightno' , '$seatsel[$k]' , '$last_id')";
                    ...
                    echo "<a href = \"leave.php?role=".$_GET['role']."\">Print</a>";
                    echo "</div>";
                }
