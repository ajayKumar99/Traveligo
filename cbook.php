	...
	<body>
      ...
      <h1>CRUISE BOOKING</h1>
        ...
        ob_end_clean();
            $_SESSION['dest'] = $dest;
            $_SESSION['dept'] = $dept;
            $sql = "select a.cname , r.timedept , r.timearr , a.basefare , a.cid from cruise a join routes r on a.routeno = r.routeid where r.from_x = '$dest' and r.to_x = '$dept'";
                                    ...
                                    while($rows = mysqli_fetch_row($query)){
                                        echo "<div class = \"div3\" onclick = \"location.href = 'cuserdetails.php?role=".$rows[4]."';\">";
