	...
	<body>
      ...
      <h1>TRAVELLERS</h1>
        ...
        ob_end_clean();
            ...
            $flightno = $_GET['role'];
            $sql = "select a.tname , r.from_x , r.to_x , r.timedept, r.timearr , a.basefare from trains a join routes r on a.routeno = r.routeid where a.trainid = '$flightno'";
    ...
    <?php
                ...
                if(isset($_POST['userbut'])){
                    ...
                    while($k < sizeof($usernames)){
                        $sql1 = "insert into user(username , email , phoneno , trav_date , trainno) values('$usernames[$k]' , '$emails[$k]' , '$phone[$k]' , '$traveldate' , '$flightno')";
