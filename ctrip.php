...
<link type="text/css" rel="stylesheet" href="css/style.css" />
	...
	<body>
        <video autoplay muted loop id="myVideo">
            <source src="images/cruise.webm" type="video/webm">
        </video>
        <div class = "topic">
      <h1>TRAVELLERS</h1>
        </div>
        ...
        ob_end_clean();
            ...
            $flightno = $_GET['role'];
            $sql = "select a.cname , r.from_x , r.to_x , r.timedept, r.timearr , a.basefare from cruise a join routes r on a.routeno = r.routeid where a.cid = '$flightno'";
    ...
    <?php
                ...
                if(isset($_POST['userbut'])){
                    ...
                    while($k < sizeof($usernames)){
                        $sql1 = "insert into user(username , email , phoneno , trav_date , cruiseno) values('$usernames[$k]' , '$emails[$k]' , '$phone[$k]' , '$traveldate' , '$flightno')";
  ...
  <a href="bus.php" >Bus</a>
            <a href="cruise.php"  class="active">Cruise</a>
</div>
