	...
	<body>
      ...
      <h1>BUS BOOKING</h1>
        ...
        ob_end_clean();
            $_SESSION['dest'] = $dest;
            $_SESSION['dept'] = $dept;
            $sql = "select a.bname , r.timedept , r.timearr , a.basefare , a.bid from bus a join routes r on a.routeno = r.routeid where r.from_x = '$dest' and r.to_x = '$dept'";
                                    ...
                                    while($rows = mysqli_fetch_row($query)){
                                        echo "<div class = \"div3\" onclick = \"location.href = 'buserdetails.php?role=".$rows[4]."';\">";
